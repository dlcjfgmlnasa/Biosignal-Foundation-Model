#!/bin/bash
# PaPaGei-S frozen linear-probe baseline — PPG 전용 (ppg 채널만 사용, 125Hz/10s).
# 사전: PaPaGei 레포 + weights/papagei_s.pt (Zenodo 13983110).
# 사용법:
#   FM_PAPAGEI_ROOT=/repos/papagei-foundation-model WEIGHTS=/repos/.../weights/papagei_s.pt \
...
export ENCODER=papagei
export WEIGHTS=${WEIGHTS:?WEIGHTS 필요 (예: /repos/papagei-foundation-model/weights/papagei_s.pt)}
export THIRD_PARTY_ROOT=${THIRD_PARTY_ROOT:-${FM_PAPAGEI_ROOT:-}}
