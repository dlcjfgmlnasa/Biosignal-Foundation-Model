...
-----
# 실제 모델:
python -m downstream.generation.anomaly.run --checkpoint outputs/phase1_v1/best.pt --signal-type ecg

# 더미 테스트:
python -m downstream.generation.anomaly.run --dummy --signal-type ecg
"""
