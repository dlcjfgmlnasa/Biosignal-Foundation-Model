    ...
    for epoch in range(epochs):
        ...
        for batch_start in range(0, len(order), batch_size):
            ...
            if ddp_module is not None:
                ...
                labels = torch.tensor(
                    [p["extubation"] for p in batch_patients],
...
def main() -> None:
    ...
    if use_ddp and use_lora:
        ...
        def _extract_shard_tuples(patients):
            ...
            for gi in idxs:
                ...
                out.append(
                    (gi, reprs.detach().cpu(), p["extubation"], str(p["subject_id"]))
                )
            return out
        ...
        train_patients = [
            {"extubation": lbl, "subject_id": cid, "n_windows": r.shape[0]}
    ...
    roc_path = out_dir / f"extubation_roc_{args.mode}{fold_suffix}.png"
    ...
    results_path = out_dir / f"extubation_results_{args.mode}{fold_suffix}.json"
