...
사용법:
    python -m downstream.outcome.mortality.build_records_to_download \
        --cohort-csv downstream/outcome/mortality/bquxjob_6a8255f2_19d9042b214.csv \
        --records-file downstream/outcome/sepsis/RECORDS-waveforms \
        --out-file downstream/outcome/mortality/RECORDS-to-download
"""
...
from downstream.outcome.mortality.download_waveforms import (
    load_cohort,
    load_waveform_index,
...
def main() -> None:
    ...
    parser.add_argument(
        "--out-file", type=str,
        default="downstream/outcome/mortality/RECORDS-to-download",
    )
